...
import { Search, ArrowLeft, Code, Video, PenTool, Megaphone, MonitorPlay, Sparkles } from 'lucide-react'
...
// ✅ دالة تنظيف النص من Markdown الخام القادم من قاعدة البيانات
...
function SliderImage({ src, alt }: { src: string; alt: string }) {
  ...
  if (!src || imgError) {
    return <span className="text-sm text-amber-400 font-bold tracking-wider">BAKR</span>
  }
  ...
  return (
    <section className="relative pt-24 pb-16 md:pt-40 md:pb-24 overflow-hidden bg-gradient-to-b from-[#020817] via-[#0b1021] to-[#0f0c29] border-b border-indigo-900/30">
      <div className="container px-4 mx-auto text-center z-10 relative">
        ...
        <motion.h1
          className="text-5xl md:text-7xl font-extrabold tracking-tight mb-6 text-slate-50 drop-shadow-lg"
          initial={{ opacity: 0, y: -20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ delay: 0.1 }}
        >
          مرحباً بك في{' '}
          <span className="text-transparent bg-clip-text bg-gradient-to-l from-amber-200 via-yellow-400 to-amber-600 drop-shadow-[0_0_20px_rgba(251,191,36,0.5)]">
            BAKR AI
          </span>
        </motion.h1>
        ...
        >
          دليلك الشامل لاستكشاف أقوى أدوات الذكاء الاصطناعي لتتخطى بها حدود المألوف، تضاعف إنتاجيتك، وتربح العمولات بذكاء.
        </motion.p>
        ...
        >
          <div className="relative flex-1">
            ...
            <Input
              ...
              className="pr-12 pl-4 h-14 w-full text-lg rounded-full bg-slate-900/40 backdrop-blur-md border-slate-700/50 text-slate-100 placeholder:text-slate-400/60 focus-visible:ring-amber-500 shadow-inner"
              dir="rtl"
            />
          </div>
          <Button
            type="submit"
            size="lg"
            className="h-14 rounded-full px-8 text-lg bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-400 hover:to-orange-400 text-slate-950 font-extrabold border-0 shadow-[0_0_20px_rgba(251,191,36,0.4)] hover:shadow-[0_0_30px_rgba(251,191,36,0.6)] transition-all"
          >
            استكشف الأدوات
          </Button>
        </motion.form>
      ...
      <div className="absolute top-1/4 left-1/4 w-[500px] h-[500px] bg-amber-500/10 rounded-full blur-[150px] -z-10 pointer-events-none" />
      <div className="absolute bottom-1/4 right-1/4 w-[600px] h-[600px] bg-emerald-600/10 rounded-full blur-[150px] -z-10 pointer-events-none" />
    </section>
  )
}
...
export function StatsBar() {
  return (
    <motion.section
      {...fadeIn}
      className="border-b border-slate-800/60 bg-[#020817]/80 backdrop-blur-xl relative z-20"
    >
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center divide-y md:divide-y-0 md:divide-x md:divide-x-reverse border-slate-800/60">
          <div className="flex flex-col space-y-2 pt-4 md:pt-0">
            <span className="text-4xl font-black text-transparent bg-clip-text bg-gradient-to-br from-amber-200 to-amber-500 drop-shadow-sm">
              1,200+
            </span>
    ...
    <section className="py-16 bg-[#020817] overflow-hidden">
      ...
      <div className="flex justify-between items-end mb-4 px-4 max-w-7xl mx-auto relative z-20">
        <div>
          ...
          <p className="text-slate-400">أفضل أدوات الذكاء الاصطناعي التي نوصي بها حالياً.</p>
        </div>
      </div>
        ...
        >
          {tools.map((tool) => (
            <SwiperSlide
              ...
              className="py-6"
            >
              <div className="relative group h-full px-2">
                <div className="absolute -inset-1.5 bg-gradient-to-r from-amber-400 via-yellow-500 to-orange-500 rounded-3xl blur-2xl opacity-0 group-hover:opacity-70 transition-all duration-500 pointer-events-none" />

                <Link
                  href={`/tools/${tool.slug || tool.id}`}
                  className="block relative z-10 h-full outline-none"
                >
                  <div className="relative border border-slate-800/80 rounded-2xl p-6 bg-[#050505]/95 backdrop-blur-xl shadow-2xl transition-all duration-500 group-hover:-translate-y-2 group-hover:border-amber-400 group-hover:shadow-[0_0_30px_rgba(251,191,36,0.3)] flex flex-col justify-between h-[360px] overflow-hidden">
                    ...
                    <div className="absolute top-0 left-0 right-0 h-32 bg-gradient-to-b from-amber-500/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none" />
                    ...
                    <div className="flex flex-col items-center text-center mb-6 relative z-10">
                      ...
                      {/* ✅ إصلاح المربع الأبيض: حذف bg-gradient-to-r من الحالة العادية */}
                      ...
                      <p className="text-slate-400 text-sm line-clamp-3 leading-relaxed group-hover:text-slate-300 transition-colors duration-300">
                        {cleanMarkdown(tool.description) || 'وصف الأداة غير متوفر حالياً.'}
                      </p>
                    </div>
    ...
    <section className="py-20 border-t border-slate-800/60 bg-gradient-to-b from-[#020817] to-[#0a0514]">
      <div className="container px-4 mx-auto max-w-7xl">
        <div className="flex flex-col items-center mb-12">
          ...
          <div className="w-24 h-1 bg-gradient-to-r from-transparent via-amber-500 to-transparent rounded-full opacity-50" />
        </div>
          ...
          {categories.map((cat, idx) => {
            ...
            return (
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <Card className="bg-slate-900/30 backdrop-blur-sm border-slate-800/60 hover:border-amber-400/50 hover:bg-slate-800/50 hover:shadow-[0_10px_30px_rgba(251,191,36,0.15)] transition-all duration-300 cursor-pointer text-center group">
                  <CardContent className="p-6 flex flex-col items-center justify-center space-y-4">
                    <div className="p-4 bg-slate-950 rounded-2xl text-slate-400 group-hover:bg-amber-500/10 group-hover:text-amber-400 group-hover:scale-110 transition-all duration-300 border border-slate-800 group-hover:border-amber-400/30">
      ...
      <div className="container px-4 mx-auto max-w-5xl">
        <div className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-950 border border-slate-700/50 text-white rounded-[2.5rem] p-8 md:p-16 text-center overflow-hidden relative shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
          <div className="relative z-10">
            <h2 className="text-3xl md:text-5xl font-extrabold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-amber-200 to-yellow-500">
              لا تفوت سحر الذكاء الاصطناعي!
            </h2>
            ...
            >
              <Input
                ...
                className="bg-slate-950/50 backdrop-blur-md border border-slate-600/40 text-white h-14 placeholder:text-slate-400/60 text-right text-base focus-visible:ring-amber-500 rounded-2xl shadow-inner"
                required
                dir="rtl"
              />
              <Button
                size="lg"
                className="h-14 w-full sm:w-auto shrink-0 bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-400 hover:to-orange-400 text-slate-950 font-bold rounded-2xl shadow-lg hover:shadow-[0_0_20px_rgba(251,191,36,0.4)] transition-all duration-300"
              >
